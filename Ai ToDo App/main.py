...
def add_task(task,desc=None):
    """Add a new task to the users task list. Use this when the user wants to
    add or create a task"""
    todoist.add_task(content=task,description=desc)

@tool
def show_tasks():
    """Show all tasks from the Todoist task list"""
...
system_prompt = """You are a helpful assistant, "
                ...
                "You will help the user show existing tasks. If the user asks "
                "to show the tasks: for example, "show me the tasks" print out 
                the tasks to the user. Print them in a bullet list format
                """
